...
int main(int argc, char **argv)
{
	...
	client.receive();
	client.delSubscriber_Normal("01257780871", "Power");
	client.receive();
	client.delSubscriber_Normal("01257780873", "Power");
	client.receive();
	client.delSubscriber_Normal("01257780872", "Power");
	client.receive();
	client.getSubscriberList_Normal("Power");
	client.receive();
